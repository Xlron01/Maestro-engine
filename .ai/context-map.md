...
- **الملفات البرمجية ذات الصلة:**
  - [`scripts/SimClock.gd`](scripts/SimClock.gd)
  - [`scripts/WorldState.gd`](scripts/WorldState.gd)
  - [`scripts/EventQueue.gd`](scripts/EventQueue.gd)
  - [`scripts/ScheduledQueue.gd`](scripts/ScheduledQueue.gd)
  - [`scripts/ActivationSet.gd`](scripts/ActivationSet.gd)
...
- **الملفات البرمجية ذات الصلة:**
  - [`scripts/ContentLoader.gd`](scripts/ContentLoader.gd)
  - [`scripts/ContentSchema.gd`](scripts/ContentSchema.gd)
- **ملفات البيانات ذات الصلة:**
  - [`data/rules/politics.json`](data/rules/politics.json)
...
- **الملفات البرمجية ذات الصلة:**
  - [`scripts/DecisionSystem.gd`](scripts/DecisionSystem.gd)
- **قرارات ومستندات للقراءة:**
  - `.ai/decisions/002-data-driven-rules.md`
...
- **الملفات البرمجية ذات الصلة:**
  - [`scripts/Simulation.gd`](scripts/Simulation.gd)
- **قرارات ومستندات للقراءة:**
...
- **الملفات البرمجية ذات الصلة:**
  - [`scripts/ScenarioTest.gd`](scripts/ScenarioTest.gd)
  - [`scripts/validate_memory.py`](scripts/validate_memory.py)
  - [`scripts/test_phase6_step4.gd`](scripts/test_phase6_step4.gd)
  - [`scripts/test_phase6_step5.gd`](scripts/test_phase6_step5.gd)

...
### Tests
- **Model v1 FROZEN — Integration Gate PASS 7/7 (§9.3):** القناتان + السلاسل على عالم موحد (ASML-pattern)؛ I-1 Supply mirror exact | I-2 dp=0.8 بالضبط | I-3 Access mirror exact | I-4 L1-joint bitwise تحت انقلاب نية/عداء | I-5 صفر مفاتيح تجميعية | I-7 حتمية مزدوجة. ScenarioTest regression **5/5 + Checksum ثابت**. القيم: exposure=1.05، access=0.84، rel_supply=0.945، total=1.785. Evidence: `model_v1_integration.log` | `model_v1_freeze_scenariotest.log`.
